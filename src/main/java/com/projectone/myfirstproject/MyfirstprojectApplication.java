package com.projectone.myfirstproject;
...
import com.projectone.myfirstproject.entities.Category;
import com.projectone.myfirstproject.entities.Product;
import com.projectone.myfirstproject.repositories.CategoryRepository;
...
public class MyfirstprojectApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(null, "Domain Drive", 120.00, cat2);
